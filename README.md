...
- **Quality-gated on every PR.** CI runs lint, tests, type-tests, circular-import checks ([`dpdm`](https://github.com/acrazing/dpdm)), bundle-size budget ([`size-limit`](https://github.com/ai/size-limit)), dead-code ([`knip`](https://knip.dev/)) and monorepo consistency ([`sherif`](https://github.com/QuiiBz/sherif)).
