...
- c29744e: - Nuevo método `getRanges(ranges, objectKeys?)`: lee varias ranges de la misma
...
- 34ce2e3: - `getRange` devuelve `[]` ante un rango vacío en vez de lanzar (un rango sin datos es
