...
// La jerarquia de errores publica vive en ./errors (contrato transversal), no aca:
// este modulo es transporte. La importamos para clasificar los fallos de red.
const { YouTubeApiError, RateLimitError, QuotaExceededError } = require('../errors');
